...
<div class="container" style="padding-top: 10em;padding-left: 4em;"></div>

<!-- Video alignment start -->

<div style="padding-top: 2em;" class="container">
    <div class="box">
        <div class="row" style="padding: 1em;">
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                <iframe src="https://www.youtube.com/embed/PyvynQPm2Wo" title="YouTube video player"    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
            </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                <p class="container" style="padding-top: 2em;padding-left: 2em;">Description about the Video</p>
            </div> 
        </div>
    </div>
</div>
