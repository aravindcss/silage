$(document).ready(function() {
    ...
    $('select.sef_year').on('change', function() {
        ...
        $.get(site_url+'/ajax/corporate-announcements-months/', { year: year, type: type }, function(data) 
        {
    ...
    $('select.sef_month').on('change', function() {
        ...
        $.get(site_url+'/ajax/corporate-announcements', {year: year, month: month, type: type }, function(data) 
        {
