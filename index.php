...
<section id="landing" class="title_desc_left fwp">
	...
	<div class="fw owl-carousel owl-theme" id="landing_other_slider">
		<div class="slide_item item-video"><img src="public/IMG-20210325-WA0001.jpg">&nbsp;</div>
		<div class="slide_item item-video"><img src="public/IMG-20210324-WA0069.jpg">&nbsp;</div>
		<div class="slide_item item-video"><img src="public/IMG-20210325-WA0023.jpg">&nbsp;</div>
		<!-- <div class="slide_item item-video" id="banner_goodness03">&nbsp;</div> -->
	</div>
		...
		<div class="row">			
			<div class="col-md-10 col-md-offset-1">
				<div class="fw desc txc">
					...
					<h3 class="wow fadeInUp animated fast"style="margin-top: 10px;">We constantly innovate <br>to feed cattles and improve  productivity </h3>
				</div>
			</div>
			<div class="col-md-12">
				<div class="fw pr">
		...
		<div class="row pr">			
			<div class="col-md-12">
				<div class="fw desc txc wow fadeInUp animated">
					<h2><a href="investors.html" class="blue">Investors</a></h2>
					...
					<a href="investors.html" class="learnmore">Explore</a>
				</div>
			</div>
			<div class="col-md-12">
